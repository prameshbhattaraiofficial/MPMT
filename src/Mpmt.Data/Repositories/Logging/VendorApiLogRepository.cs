...
{
    public class VendorApiLogRepository : IVendorApiLogRepository
    {
        public async Task LogInsertAsync(VendorApiLogParam log)
        {
            ...
            param.Add("@PartnerTransactionId", log.PartnerTransactionId);
            param.Add("@PartnerProcessId", log.PartnerProcessId);
            ...
            await connection.ExecuteAsync("[dbo].[usp_insert_api_log]", param, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task LogUpdateAsync(VendorApiLogParam log)
        {
            ...
            await connection.ExecuteAsync("[dbo].[usp_update_vendor_api_log]", param, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task LogUpdateVendorApiExceptionAsync(VendorApiLogParam log)
        {
            ...
            await connection.ExecuteAsync("[dbo].[usp_update_vendor_api_exception_log]", param, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task LogUpdateVendorApiException2Async(VendorApiLogParam log)
        {
            ...
            await connection.ExecuteAsync("[dbo].[usp_update_vendor_api_exception_log2]", param, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task LogUpdateVendorApiException3Async(VendorApiLogParam log)
        {
            ...
            await connection.ExecuteAsync("[dbo].[usp_update_vendor_api_exception_log3]", param, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task LogUpdateVendorApiResponseAsync(VendorApiLogParam log)
        {
            ...
            await connection.ExecuteAsync("[dbo].[usp_update_vendor_api_response_log]", param, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task LogUpdateVendorApiResponse2Async(VendorApiLogParam log)
        {
            ...
            await connection.ExecuteAsync("[dbo].[usp_update_vendor_api_response_log2]", param, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task LogUpdateVendorApiResponse3Async(VendorApiLogParam log)
        {
            ...
            await connection.ExecuteAsync("[dbo].[usp_update_vendor_api_response_log3]", param, commandType: CommandType.StoredProcedure);
        }
    }
}
