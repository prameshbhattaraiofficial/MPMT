...
{
    public class PartnerModuleActionRepository: IPartnerModuleActionRepository
    {
        /// <summary>
        ...
        {
            using var connection = DbConnectionManager.GetDefaultConnection();
            return await connection.QueryAsync<PartnerModuleActionModelView>("[dbo].[usp_get_module_action]", commandType: CommandType.StoredProcedure);
        }
        ...
        /// <returns>A Task.</returns>
        public async Task<IUDPartnerModuleAction> GetModuleActionByIdAsync(int ModuleActionId)
        {
            using var connection = DbConnectionManager.GetDefaultConnection();
            var param = new DynamicParameters();
            param.Add("@Id", ModuleActionId);
            var result = await connection.QueryAsync<IUDPartnerModuleAction>("[dbo].[usp_get_module_action_ById]", param, commandType: CommandType.StoredProcedure);
