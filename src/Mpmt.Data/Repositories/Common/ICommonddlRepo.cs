...
namespace Mpmt.Data.Repositories.Common
{
    ...
    public interface ICommonddlRepo
    {
        ...
        Task<IEnumerable<Commonddl>> GetIncomeSource();
        /// <summary>
        /// Getoccupations the.
        /// </summary>
        /// <returns>A Task.</returns>
        Task<IEnumerable<Commonddl>> Getoccupation();
        ...
        Task<IEnumerable<Commonddl>> GetAdminPartnerRoleddl();
        ...
        //Task<daaaata> aasdsadGetDocumentCharacterByDocumentType();
