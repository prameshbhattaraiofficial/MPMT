...
namespace Mpmt.Web.Areas.Partner.Controllers
{
    [AdminAuthorization]
    [RolePremission]
    public class PartnerMenuController : BasePartnerController
    {
        ...
        {
            var actions = await _rMPService.GetPartnerActionPermissionList("PartnerMenu");
        ...
        [HttpPost]
        [LogUserActivity("Add Partner Menu")]
