!(function (r) {
  ...
  (e.prototype.createBasic = function (e) {
    ...
    (e.prototype.createWithPolygon = function (e, t) {
      var n = new GMaps({ div: e, lat: -12.043333, lng: -77.028333 });
      n.drawPolygon({
        paths: t,
        strokeColor: "#BBD8E9",
        strokeOpacity: 1,
    ...
    (e.prototype.createWithStreetview = function (e, t, n) {
      return GMaps.createPanorama({ el: e, lat: t, lng: n });
    }),
    (e.prototype.createWithRoutes = function (e, t, n) {
      var a = new GMaps({ div: e, lat: t, lng: n });
      return (
        r("#start_travel").click(function (e) {
          e.preventDefault(),
            a.travelRoute({
              ...
              travelMode: "driving",
              step: function (e) {
                r("#instructions").append("<li>" + e.instructions + "</li>"),
                  r("#instructions li:eq(" + e.step_number + ")")
                    .delay(450 * e.step_number)
                    .fadeIn(200, function () {
                      a.setCenter(e.end_location.lat(), e.end_location.lng()),
                        a.drawPolyline({
                          path: e.path,
                          strokeColor: "#131540",
                          strokeOpacity: 0.6,
    ...
    (e.prototype.createWithMenu = function (e, t, n) {
      new GMaps({ div: e, lat: t, lng: n }).setContextMenu({
        control: "map",
        options: [
          {
            title: "Add marker",
