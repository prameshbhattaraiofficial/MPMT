...
var randomizeArray = function (e) {
  ...
  spark1 = {
    ...
    fill: { opacity: 0.2 },
    series: [{ name: "Xpress Sewa Senders", data: randomizeArray(sparklineData) }],
    yaxis: { min: 0 },
    colors: ["#f93b7a"],
    title: {
      text: "$424,652",
...
var spark2 = {
  ...
  stroke: { width: 2, curve: "straight" },
  fill: { opacity: 0.2 },
  series: [{ name: "Xpress Sewa Receivers ", data: randomizeArray(sparklineData) }],
  yaxis: { min: 0 },
  colors: ["#fbb624"],
  title: {
    text: "$235,312",
...
var spark3 = {
  ...
  stroke: { width: 2, curve: "straight" },
  fill: { opacity: 0.2 },
  series: [{ name: "Total Transactions ", data: randomizeArray(sparklineData) }],
