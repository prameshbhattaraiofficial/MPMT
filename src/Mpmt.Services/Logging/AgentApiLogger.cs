...
{
    public class AgentApiLogger : IAgentApiLogger
    {
        private int _logUpdateCount = 0;
        private AppVendorApiLog _logContext;

        private readonly IMapper _mapper;
        private readonly IAgentApiLogRepository _agentApiLogRepository;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IWebHostEnvironment _hostEnv;

        public AgentApiLogger(
            IMapper mapper,
            IAgentApiLogRepository agentApiLogRepository,
            IHttpContextAccessor httpContextAccessor,
            IWebHostEnvironment hostEnv)
        {
            _mapper = mapper;
            _agentApiLogRepository = agentApiLogRepository;
            ...
            string memberName = null, string deviceCode = null, string ipAddress = null, string platform = null, string machineName = null, string environment = null)
        {
            try
            {
                ...
                await _agentApiLogRepository.LogInsertAsync(log);
            ...
            string vendorTransactionId3 = null, string vendorTrackerId3 = null, string vendorId3 = null, string vendorType3 = null)
        {
            ...
            try
            {
                ...
                await _agentApiLogRepository.LogUpdateAsync(log);
                IncrementLogUpdateCount();
            }
            catch (Exception) { }
        }
