...
namespace Mpmt.Services.Services.DocumentType
{
    ...
    public interface IDocumentTypeServices
    {
        ...
        /// <returns>A Task.</returns>
        Task<SprocMessage> AddDocumentTypeAsync(AddDocumentTypeVm addDocumentType);
        /// <summary>
        /// Updates the document type async.
        /// </summary>
        /// <param name="updateDocumentType">The update document type.</param>
        /// <returns>A Task.</returns>
        Task<SprocMessage> UpdateDocumentTypeAsync(UpdateDocumentTypeVm updateDocumentType);
        /// <summary>
        /// Removes the document type async.
        /// </summary>
        /// <param name="removeDocumentType">The remove document type.</param>
        /// <returns>A Task.</returns>
        Task<SprocMessage> RemoveDocumentTypeAsync(UpdateDocumentTypeVm removeDocumentType);
    }
}
