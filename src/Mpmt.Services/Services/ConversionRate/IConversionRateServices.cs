...
namespace Mpmt.Services.Services.ConversionRate
{
    ...
    /// </summary>
    public interface IConversionRateServices
    {
        /// <summary>
        ...
        /// <returns>A Task.</returns>
        Task<SprocMessage> AddConversionRateAsync(AddConversionRateVm addConversionRate);
        /// <summary>
        /// Updates the conversion rate async.
        /// </summary>
        /// <param name="updateConversionRate">The update conversion rate.</param>
        /// <returns>A Task.</returns>
        Task<(SprocMessage, IEnumerable<ExchangeRateChangedListPartner>)> UpdateConversionRateAsync(UpdateConversionRateVm updateConversionRate);
        /// <summary>
        /// Removes the conversion rate async.
        /// </summary>
        /// <param name="removeConversionRate">The remove conversion rate.</param>
        /// <returns>A Task.</returns>
        Task<SprocMessage> RemoveConversionRateAsync(UpdateConversionRateVm removeConversionRate);
    }
}
