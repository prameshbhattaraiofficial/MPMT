...
namespace Mpmt.Services.Services.PreFund
{
    ...
    /// </summary>
    public interface IPreFundRequestServices
    {
        /// <summary>
        ...
        /// <returns>A Task.</returns>
        Task<FundRequestApprovedView> GetPreFundRequestApprovedByIdAsync(int Prefund);
        ...
        /// <returns>A Task.</returns>
        Task<SprocMessage> ApprovedFundRequestStatusAsync(FundRequestStatusUpdate fundRequestStatus, ClaimsPrincipal User);
        /// <summary>
        ...
        /// <param name="User">The user.</param>
        /// <returns>A Task.</returns>
        Task<SprocMessage> RejectFundRequestStatusAsync(FundRequestStatusUpdate fundRequestStatus, ClaimsPrincipal User);
