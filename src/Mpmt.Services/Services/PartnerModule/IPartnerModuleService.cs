...
{
    public interface IPartnerModuleService
    {
        /// <summary>
        ...
        /// <param name="module">The module.</param>
        /// <returns>A Task.</returns>
        Task<SprocMessage> UpdateModuleDisplayOrderAsync(IUDPartnerModule module);
        /// <summary>
        /// Updates the module is active async.
        /// </summary>
        /// <param name="module">The module.</param>
        /// <returns>A Task.</returns>
        Task<SprocMessage> UpdateModuleIsActiveAsync(IUDPartnerModule module);
    }
}
