...
{
    public sealed class LogRequestAgentAttribute : TypeFilterAttribute
    {
        public LogRequestAgentAttribute() : base(typeof(LogRequestFilter)) { }

        public class LogRequestFilter : IAsyncResourceFilter
        {
            private readonly IAgentApiLogger _vendorApiLogger;

            public LogRequestFilter(IAgentApiLogger vendorApiLogger)
            {
