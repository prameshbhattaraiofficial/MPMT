...
namespace Mpmt.Core.Common.Attributes
{
    public class MpmtEmailAttribute : ValidationAttribute
    {
        ...
        {
            var isValidEmail = IsValidEmail(value?.ToString());
        ...
        private bool IsValidEmail(string email)
        {
            ...
            return new Regex(_emailExpression).IsMatch(email);
        }
    }
}
