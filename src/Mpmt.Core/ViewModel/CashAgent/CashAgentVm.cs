...
public class CashAgentVm
{
    public int Id { get; set; }
    [Required(ErrorMessage = "Username is required.")]
    //[Remote(action: "VerifyUserName", controller: "AdminUser")]
    [Remote(action: "VerifyUserName", controller: "Agent")]
    ...
    [Remote(action: "VerifyContactNumber", controller: "Agent")]
    ...
    [Remote(action: "VerifyRegistrationNumber", controller: "Agent")]
