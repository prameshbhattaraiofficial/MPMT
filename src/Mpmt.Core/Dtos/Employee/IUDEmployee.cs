namespace Mpmt.Core.Dtos.Employee
{
    ...
    public class IUDEmployee
    {
        ...
        /// </summary>
        public DateTime DateOfBirth { get; set; } = Convert.ToDateTime("01/01/1900");
        /// <summary>
        /// Gets or sets the date of joining.
        /// </summary>
        public DateTime DateOfJoining { get; set; } = Convert.ToDateTime("01/01/1900");
        /// <summary>
